...
class bbGammaShieldModule(bbModule.bbModule):
    ...
    def __init__(self, name : str, aliases : List[str], effect=0, value=0, wiki="", manufacturer="", icon="", emoji=lib.emojis.dumbEmoji.EMPTY, techLevel=-1, builtIn=False):
        """
...
def fromDict(moduleDict : dict) -> bbGammaShieldModule:
