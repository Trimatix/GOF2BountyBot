...
class bbTractorBeamModule(bbModule.bbModule):
    def __init__(self, name, aliases, timeToLock=0, value=0, wiki="", manufacturer="", icon="", emoji="", techLevel=-1):
        super(bbTractorBeamModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel)
