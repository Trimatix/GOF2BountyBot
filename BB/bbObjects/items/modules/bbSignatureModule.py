...
class bbSignatureModule(bbModule.bbModule):
    def __init__(self, name, aliases, manufacturer, value=0, wiki="", icon="", emoji=""):
        super(bbSignatureModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji)
