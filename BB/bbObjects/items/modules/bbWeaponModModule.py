...
class bbWeaponModModule(bbModule.bbModule):
    def __init__(self, name, aliases, dpsMultiplier=1, value=0, wiki="", manufacturer="", icon="", emoji="", techLevel=-1):
        super(bbWeaponModModule, self).__init__(name, aliases, dpsMultiplier=dpsMultiplier, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel)
