...
class bbShieldModule(bbModule.bbModule):
    def __init__(self, name, aliases, shield=0, value=0, wiki="", manufacturer="", icon="", emoji=""):
        super(bbShieldModule, self).__init__(name, aliases, shield=shield, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji)
