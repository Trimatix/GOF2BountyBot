...
class bbRepairBotModule(bbModule.bbModule):
    def __init__(self, name, aliases, HPps=0, value=0, wiki="", manufacturer="", icon="", emoji="", techLevel=-1):
        super(bbRepairBotModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel)
