...
class bbShieldInjectorModule(bbModule.bbModule):
    ...
    def __init__(self, name : str, aliases : List[str], plasmaConsumption=0, value=0, wiki="", manufacturer="", icon="", emoji=lib.emojis.dumbEmoji.EMPTY, techLevel=-1, builtIn=False):
        """
        :param str name: The name of the module. Must be unique.
        :param list[str] aliases: Alternative names by which this module may be referred to
        :param int plasmaConsumption: The amount of plasma required to refill shields (Default 0)
...
def fromDict(moduleDict : dict) -> bbShieldInjectorModule:
