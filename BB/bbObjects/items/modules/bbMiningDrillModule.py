...
class bbMiningDrillModule(bbModule.bbModule):
    def __init__(self, name, aliases, oreYield=0, handling=0, value=0, wiki="", manufacturer="", icon="", emoji="", techLevel=-1):
        super(bbMiningDrillModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel)
