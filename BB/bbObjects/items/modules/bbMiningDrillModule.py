...
class bbMiningDrillModule(bbModule.bbModule):
    ...
    def __init__(self, name : str, aliases : List[str], oreYield=0, handling=0, value=0, wiki="", manufacturer="", icon="", emoji=bbUtil.EMPTY_DUMBEMOJI, techLevel=-1, builtIn=False):
        """
