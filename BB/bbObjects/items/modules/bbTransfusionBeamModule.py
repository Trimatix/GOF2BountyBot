...
class bbTransfusionBeamModule(bbModule.bbModule):
    ...
    def __init__(self, name : str, aliases : List[str], HPps=0, count=0, value=0, wiki="", manufacturer="", icon="", emoji=lib.emojis.dumbEmoji.EMPTY, techLevel=-1, builtIn=False):
        """
...
def fromDict(moduleDict : dict) -> bbTransfusionBeamModule:
