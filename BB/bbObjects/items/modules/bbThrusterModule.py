...
class bbThrusterModule(bbModule.bbModule):
    def __init__(self, name, aliases, handlingMultiplier=1, value=0, wiki="", manufacturer="", icon="", emoji="", techLevel=-1):
        super(bbThrusterModule, self).__init__(name, aliases, handlingMultiplier=handlingMultiplier, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel)
