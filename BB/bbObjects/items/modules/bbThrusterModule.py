...
class bbThrusterModule(bbModule.bbModule):
    ...
    def __init__(self, name : str, aliases : List[str], handlingMultiplier=1, value=0, wiki="", manufacturer="", icon="", emoji=bbUtil.EMPTY_DUMBEMOJI, techLevel=-1, builtIn=False):
        """
