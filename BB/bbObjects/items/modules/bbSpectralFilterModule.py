...
class bbSpectralFilterModule(bbModule.bbModule):
    def __init__(self, name, aliases, showInfo=False, showOnRadar=False, value=0, wiki="", manufacturer="", icon="", emoji="", techLevel=-1):
        super(bbSpectralFilterModule, self).__init__(name, aliases, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel)
