...
class bbCompressorModule(bbModule.bbModule):
    def __init__(self, name, aliases, cargoMultiplier=1.0, value=0, wiki="", manufacturer="", icon="", emoji="", techLevel=-1):
        super(bbCompressorModule, self).__init__(name, aliases, cargoMultiplier=cargoMultiplier, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel)
