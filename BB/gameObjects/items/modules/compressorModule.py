...
@spawnableItem
class CompressorModule(moduleItem.ModuleItem):
    ...
    def __init__(self, name : str, aliases : List[str], cargoMultiplier : int = 1.0, value : int = 0,
        ...
        """
        super(CompressorModule, self).__init__(name, aliases, cargoMultiplier=cargoMultiplier, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel, builtIn=builtIn)
    ...
    def fromDict(cls, moduleDict : dict, **kwargs):
        ...
        return CompressorModule(moduleDict["name"], moduleDict["aliases"] if "aliases" in moduleDict else [], cargoMultiplier=moduleDict["cargoMultiplier"] if "cargoMultiplier" in moduleDict else 1,
