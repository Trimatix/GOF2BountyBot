...
@spawnableItem
class ShieldModule(moduleItem.ModuleItem):
    ...
    def __init__(self, name : str, aliases : List[str], shield : int = 0, value : int = 0,
        ...
        """
        super(ShieldModule, self).__init__(name, aliases, shield=shield, value=value, wiki=wiki, manufacturer=manufacturer, icon=icon, emoji=emoji, techLevel=techLevel, builtIn=builtIn)
    ...
    def toDict(self, **kwargs) -> dict:
        ...
        :rtype: dict
        """
        itemDict = super(ShieldModule, self).toDict(**kwargs)
        return itemDict
    ...
    def fromDict(cls, moduleDict : dict, **kwargs):
        ...
        return ShieldModule(moduleDict["name"], moduleDict["aliases"] if "aliases" in moduleDict else [], shield=moduleDict["shield"] if "shield" in moduleDict else 0,
