...
bbCommands.register("cancel", dummy_command)
dmCommands.register("cancel", dummy_command)
...
async def cmd_poll(message : discord.Message, args : str, isDM : bool):
    ...
    for arg in argsSplit[1:]:
        ...
        argPos += 1
        try:
            optionName, dumbReact = arg.strip(" ")[arg.strip(" ").index(" ")+1:], bbUtil.dumbEmojiFromStr(arg.strip(" ").split(" ")[0])
